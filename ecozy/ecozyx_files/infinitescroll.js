...
;(function($){
  ...
  $.fn.infinitescroll = function(options,callback){
    ...
    $.fn.infinitescroll.loadingMsg = $('<div class="loading_posts"><br /><span>' + opts.loadingText + '</span></div>');
  ...
  function isNearBottom(opts,props){
      return (  $(document).height() - $(document).scrollTop() - $(window).height() - 500 <  props.scrollDelta);    
  }
  			...
  			box
  			  ...
  			  .load( path.join( props.currPage ) + ' ' + opts.itemSelector,null,function(){
  			        ...
  			        if (props.isDone){ // if we've hit the last page...
      		            ...
      		            props.loadingMsg.fadeOut('fast' ); // currently makes the <em>'d text ugly in IE6
